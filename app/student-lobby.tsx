...
export default function StudentLobby({ loading, onGoogleLogin }: Props) {
  return <main className="student-lobby enem-lobby">
    ...
    <section className="lobby-shell welcome">
      <div className="lobby-story"><span className="lobby-pill">FOCO TOTAL NO ENEM</span><h1>Seu próximo passo já está pronto.</h1><p>Um único painel para seguir o cronograma, dominar 747 habilidades, praticar 2.000 questões e acompanhar provas e simulados.</p>
      ...
      <div className="lobby-card"><span className="eyebrow">ACESSO À PLATAFORMA</span><h2>Entre e continue de onde parou.</h2><p>O Google protege sua conta. No primeiro acesso, você confirma nome, nome de exibição e RA + dígito.</p>
        ...
        <div className="lobby-enem-numbers"><span><strong>747</strong> habilidades</span><span><strong>2.000</strong> questões</span><span><strong>17</strong> provas internas</span></div>
      </div>
    </section>
