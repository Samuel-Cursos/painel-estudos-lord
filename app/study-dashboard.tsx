...
export default function StudyDashboard() {
  ...
  function updateAssessmentRecord(name: string, record: AssessmentRecord) { const next = { ...assessmentResults, [name]: record }; setAssessmentResults(next); window.localStorage.setItem("lord-enem-assessments", JSON.stringify(next)); }
